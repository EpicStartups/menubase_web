...
{
  id: 'hh-wc',
  name: 'Happy Hour White Coffee',
  emoji: '☕',
  price: 6.30,
  cat: 'Happy Hour',
  visibility: 'campaign_controlled',
  twinOf: 'wc'
}, {
  id: 'hh-ml',
  name: 'Happy Hour Matcha Latte',
  emoji: '🍵',
  price: 8.40,
  cat: 'Happy Hour',
  visibility: 'campaign_controlled',
...
const DEMO_CAMPAIGNS = {
  threshold: [{
    id: 'd-threshold',
    type: 'threshold',
    name: 'Spend RM50, free croissant',
    status: 'active',
    activeDays: [1, 1, 1, 1, 1, 1, 1],
    startTime: '00:00',
    endTime: '23:59',
